        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white font-bold text-lg">City Library</span>
            </div>
            <p className="text-sm leading-relaxed">
              Your community hub for books, events, and lifelong learning. Discover, borrow, and explore.
            </p>
          </div>
